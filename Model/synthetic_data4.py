...
def generate_emory_courses_for_year(
    ...
    if len(courses) < min_target:
        ...
        while len(courses) < target and ger_pool:
...
if __name__ == "__main__":
    ...
    juniors = []
    incoming_test_courses = wrapper_genrate_incoming_test_for_freshman(10, 8)
    start = 21
    ...
    # sophomores = []
    # incoming_test_courses = wrapper_genrate_incoming_test_for_freshman(10, 7)
    # start = 11
    # for incoming in incoming_test_courses:
    ...
    # with open("data/synthetic_sophomores.json", "w") as f:
    #     import json
    #     json.dump(sophomores, f, indent=4)
