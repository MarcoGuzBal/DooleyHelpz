...
export default function DashboardPage() {
  ...
  const recommendedFromBackend: RecommendedClass[] | null = null;
  const latestScheduleFromBackend: ScheduleMeeting[] | null = null;
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <main className="mx-auto max-w-6xl px-4 pb-12 pt-6">
        {/* Welcome / intro */}
        <section className="mb-8 grid items-center gap-6 rounded-3xl border border-zinc-200 bg-gradient-to-tr from-emoryBlue/5 via-white to-paleGold/20 p-6 md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          <div>
